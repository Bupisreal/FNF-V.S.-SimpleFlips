...
class PlayState extends MusicBeatState
{
	...
	public static var bup:Character;
	...
	override public function create()
	{
		...
		switch (SONG.song.toLowerCase())
		{
			...
			case 'walkies':
				dialogue = CoolUtil.coolTextFile(Paths.txt('walkies/dialog'));
			case 'senpai':
			...
			case 'simpleroom':
				{
						defaultCamZoom = 0.9;
						curStage = 'simpleroom';
						var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('simpleroom'));
						bg.antialiasing = true;
						bg.active = false;
						add(bg);
